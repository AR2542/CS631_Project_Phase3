...
create table Equipment (
    ID int primary key,
    Equipment_Name varchar(31) not null,
    Equipment_Type varchar(31) not null,
...
insert into Lab_Member(Member_ID, Member_Name, Member_Type, Join_Date) values 
    ...
    (104, 'Alicia', 'Faculty', '2013-05-17'),
    (105, 'Zelaya', 'External Collaborator', '1998-10-12'),
    (106, 'Jennifer', 'Student', '2019-10-23'),
    (107, 'Wallace', 'Faculty', '2014-05-17'),
    (108, 'Ramesh', 'External Collaborator', '1998-10-12'),
    (109, 'Narayan', 'Student', '2016-08-30'),
    (110, 'Joyce', 'Faculty', '2017-05-20'),
    (111, 'English', 'External Collaborator', '1998-10-12'),
    (112, 'Ahmad', 'Student', '2019-06-22'),
    (113, 'James', 'Faculty', '2018-08-08'),
    (114, 'Borg', 'External Collaborator', '1998-10-12'),
    (115, 'Michael', 'Student', '2019-12-30'),
    (116, 'Ron', 'Student', '2018-01-27'),
    (117, 'Wade', 'Student', '2015-10-03'),
    (118, 'Trace', 'Student', '2018-10-04'),
...
insert into Mentorship(Mentor_ID, Mentee_ID, Start_Date, End_Date) values
    (101, 100, '2019-10-02', '2023-04-28'),
    (104, 100, '2019-11-12', '2022-08-19'),
    (107, 103, '2018-11-01', '2020-11-30'),
    (107, 119, '2019-10-10', '2024-05-01');
    
insert into Equipment(ID, Equipment_Name, Equipment_Type, Purchase_Date, Equipment_Status) values
    (100000, 'Test Tubes', 'Chemistry Lab Equipments', '2004-10-19', 'In Use'),
    (100001, 'Hydraulic Press', 'Mechanical Equipments', '2005-09-26', 'Not in Use'),
    (100002, 'Bunsen Burner', 'Chemistry Lab Equipments', '2003-01-30', 'In Use'),
    (100003, 'Monitor sets', 'Computer Lab Equipments', '2006-05-23', 'Not in Use'),
    (100004, 'Microscopes', 'Biology Lab Equipments', '2004-11-16', 'In Use'),
    (100005, 'Chemical Boxes', 'Chemistry Lab Equipments', '2002-10-13', 'In Use'),
    (100006, 'Pendulum Sets', 'Mechanical Equipments', '2005-08-09', 'Not in Use');

insert into Equipment_Usage(Equipment_ID, Member_ID, Purpose_of_Use, Start_Date, End_Date) values
    (100000, 101, 'Chemical Reactions', '2019-09-30', '2021-10-15'),
    (100000, 111, 'Chemical Reactions', '2019-09-30', '2021-10-15'),
    (100002, 101, 'Chemistry Reactions', '2020-01-24', '2021-10-15'),
    (100004, 112, 'Biology Research', '2018-11-04', '2022-05-09'),
    (100005, 111, 'Chemistry Reactions', '2020-10-13', '2023-12-01');

insert into Project(Project_ID, Faculty_ID, Title, Start_Date, End_Date, Project_Status, Expected_Duration) values
    (0, 101, 'ProductX', '2018-08-29', '2026-04-05', 'Ongoing', '7 years 8 months'),
    (1, 104, 'Machine Designing', '2019-10-11', '2024-11-18', 'Completed', '5 years 1 month'),
    (2, 107, 'Complex Integration', '2017-01-14', '2025-12-01', 'Completed', '8 years 11 months'),
    (3, 110, 'Exhibition', '2020-10-04', '2027-04-05', 'Ongoing', '6 years 6 months'),
    (4, 113, 'Scaling of Economy', '2018-05-17', '2019-10-19', 'Completed', '1 year 5 months');

insert into Lab_Working(Member_ID, Project_ID, Weekly_Hours, Project_Role) values 
    (101, 0, 48, 'Project Leader'),
    (100, 0, 40, 'Developer'),
    (102, 0, 36, 'Developer'),
    (105, 0, 40, 'Developer'),
    (108, 0, 39, 'Developer'),
    (115, 0, 37, 'Developer'),
    (104, 1, 48, 'Project Leader'),
    (101, 1, 40, 'Developer'),
    (103, 1, 37, 'Developer'),
    (106, 1, 38, 'Developer'),
    (109, 1, 40, 'Developer'),
    (107, 2, 48, 'Project Leader'),
    (104, 2, 39, 'Developer'),
    (111, 2, 36, 'Developer'),
    (112, 2, 37, 'Developer'),
    (116, 2, 36, 'Developer'),
    (110, 3, 48, 'Project Leader'),
    (107, 3, 40, 'Developer'), 
    (114, 3, 42, 'Developer'),
    (117, 3, 39, 'Developer'),
    (118, 3, 41, 'Developer'),
    (113, 4, 48, 'Project Leader'),
    (110, 4, 40, 'Developer'),
    (119, 4, 40, 'Developer'),
    (102, 4, 39, 'Developer'),
    (103, 4, 35, 'Developer');

insert into Project_Grant(ID, Grant_Source, Duration, Start_Date, Budget, Reporting_Requirement) values
    (2000, 'NSF', '2 years', '2023-01-01', 500000, 'Quarterly reports, Member Roles and updates'),
    (2001, 'NIH', '3 years', '2022-06-15', 750000, 'Annual reviews'),
    (2002, 'DoE', '1 year', '2024-03-20', 300000, 'Semi-annual financials'),
    (2003, 'DARPA', '4 years', '2021-11-01', 1200000, 'Quarterly and annual review'),
    (2004, 'NASA', '2 years', '2023-05-10', 650000, 'Annual technical report');

insert into Funding(Project_ID, Grant_ID) values
    (0, 2000),
    (1, 2001),
    (2, 2002),
    (3, 2003),
...
insert into Publication(ID, Title, Month_Date, Year_Date, Venue, DOI) values
    (300, 'Revolutionary Science', 5, 2024, 'California', '10.1000/aihc2024'),
    (301, 'Technology in theory', 6, 2023, 'Washington', '10.1000/rs2023'),
    (302, 'Energy-Efficient Systems', 3, 2022, 'New York', '10.1000/ees2022'),
    (303, 'Data Modeling Advances', 9, 2024, 'England', '10.1000/dma2024'),
    (304, 'Physical Prodigy', 11, 2023, 'Germany', '10.1000/qn2023');

insert into Authorship(Member_ID, Publication_ID) values
    (100, 300), 
    (101, 300), 
    (104, 300),
    (102, 301), 
...
select count(*) from Equipment_Usage;
select count(*) from Project;
select count(*) from Lab_Working;
